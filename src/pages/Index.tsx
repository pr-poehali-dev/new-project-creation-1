...
const services = [
  {
    ...
    desc: "Бесплатная консультация 24/7, помощь в сборе документов, представление интересов с нуля до конечного результата в страховой компании и в суде. Взыскиваем полный ущерб.",
    accent: true,
  },
  {
    icon: "FileText",
